                ...
                <tr>
                  ...
                  <td>
					<button type="button" style="padding: 3px; background-color: #ED6436; border: none; border-radius: 5px; color: white;">
						...
						<a href="<s:url action='delete' />accountId=<s:property value='accountId'/>"><button type="button" style="padding: 3px; background-color: #d22a2a; border: none; border-radius: 5px; color: white;">
