		  ...
		  <div class="col-12 col-sm-8 mb-5">
			...
			<div class="table-data">
                ...
                <tr>
                  ...
                  <td>
					<button type="button" style="padding: 3px; background-color: #ED6436; border: none; border-radius: 5px; color: white;">
						<i class='bx bxs-edit bx-sm'></i></button>
						<a href="<s:url action='delete' />" value="<s:property value='accountId'/>"><button type="button" style="padding: 3px; background-color: #d22a2a; border: none; border-radius: 5px; color: white;">
						<i class='bx bx-x bx-sm'></i></button></a>					
					</td>
                </tr>
          		</s:iterator>
						</tbody>
  ...
  <div class="w3-container">
    <s:form action="registerpet" id="form" style="width: 100%;">
        ...
        <div class="control-group">
          ...
          <div class="control-group">
            <sx:datetimepicker name="petBean.dateOfBirth" label="Format (yyyy-MM-dd)" displayFormat="yyyy-MM-dd" value="%{'2010-01-01'}"/>
            <p class="help-block text-danger"></p>
          </div>
          <div class="control-group">
          ...
          <s:submit value="Register Pet" class="btn btn-primary py-3 px-5"/>
